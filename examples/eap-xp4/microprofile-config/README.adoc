...
This example shows how to deploy an Eclipse MicroProfile application with EAP XP 4 on OpenShift.
...
----
$ helm install microprofile-config-app -f examples/eap-xp4/microprofile-config/microprofile-config-app.yaml ./charts/eap-xp4
----

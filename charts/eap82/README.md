# Helm Chart for EAP 8.2

A Helm chart for building and deploying a [JBoss EAP 8.2](https://www.redhat.com/en/technologies/jboss-middleware/application-platform) application on OpenShift.
...
| `build.s2i.jdk` | JDK Version of the EAP S2I images | `"21"` | Allowed Values: `"21", "25"` |
| `build.s2i.jdk21.builderImage` | EAP S2I Builder image for JDK 21 | `registry.redhat.io/jboss-eap-8-tech-preview/eap82-openjdk21-builder-openshift-rhel10:latest` | [EAP Documentation](https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/8.2/html/getting_started_with_jboss_eap_for_openshift_container_platform/index)  |
| `build.s2i.jdk21.runtimeImage` | EAP S2I Runtime image for JDK 21| `registry.redhat.io/jboss-eap-8-tech-preview/eap82-openjdk21-runtime-openshift-rhel10:latest` | [EAP Documentation](https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/8.2/html/getting_started_with_jboss_eap_for_openshift_container_platform/index)  |
| `build.s2i.jdk25.builderImage` | EAP S2I Builder image for JDK 25 | `registry.redhat.io/jboss-eap-8-tech-preview/eap82-openjdk25-builder-openshift-rhel10:latest` | [EAP Documentation](https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/8.2/html/getting_started_with_jboss_eap_for_openshift_container_platform/index)  |
| `build.s2i.jdk25.runtimeImage` | EAP S2I Runtime image for JDK 25| `registry.redhat.io/jboss-eap-8-tech-preview/eap82-openjdk25-runtime-openshift-rhel10:latest` | [EAP Documentation](https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/8.2/html/getting_started_with_jboss_eap_for_openshift_container_platform/index)  |
...
| `build.uri` | (**required**) Git URI that references your Git repository | https://github.com/jboss-eap-up-and-running/eap82-getting-started | Be sure to specify this to build your own application. |

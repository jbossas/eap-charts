...
| `build.s2i.jdk8.builderImage` | EAP S2I Builder image for JDK 8 | `registry.redhat.io/jboss-eap-7-tech-preview/eap74-openjdk8-openshift-rhel7` | [EAP Documentation](https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.3/html/getting_started_with_jboss_eap_for_openshift_container_platform/index)  |

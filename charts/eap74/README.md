...
## The Helm Chart for EAP 7.4 is a Technology Preview feature only.
...
| `build.s2i.jdk` | JDK Version of the EAP S2I images | `"11"` | Allowed Values: `"8"`, `"11"`, `"17"` |
...
| `build.s2i.amd64.jdk17.builderImage` | EAP S2I Builder image for JDK 17 (for amd64 arch)| `registry.redhat.io/jboss-eap-7/eap74-openjdk17-openshift-rhel8` | [EAP Documentation](https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.4/html/getting_started_with_jboss_eap_for_openshift_container_platform/index)  |
| `build.s2i.amd64.jdk17.runtimeImage` | EAP S2I Runtime image for JDK 17 (for amd64 arch)| `registry.redhat.io/jboss-eap-7/eap74-openjdk17-runtime-openshift-rhel8` | [EAP Documentation](https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.4/html/getting_started_with_jboss_eap_for_openshift_container_platform/index)  |
